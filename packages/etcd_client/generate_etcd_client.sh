...
curl -L "https://raw.githubusercontent.com/etcd-io/etcd/${ETCD_VERSION}/${AUTH_PATH}/auth.proto" > "${PROTO_TARGET}/etcd/api/authpb/auth.proto"
curl -L "https://raw.githubusercontent.com/etcd-io/etcd/${ETCD_VERSION}/${MVCCPB}/kv.proto" > "${PROTO_TARGET}/etcd/api/mvccpb/kv.proto"
curl -L "https://raw.githubusercontent.com/etcd-io/etcd/${ETCD_VERSION}/${RPC_PATH}/rpc.proto" > "${PROTO_TARGET}/etcd/api/etcdserverpb/rpc.proto"
